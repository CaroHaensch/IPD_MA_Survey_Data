## Filename: ~/500_data_visualization/03_focus_transform.R
...
# Which results are not needed
tokeep<-which(erg.slope.std.err.melt$refseq=="IPD 1 St weighted"|
                  erg.slope.std.err.melt$refseq=="IPD 1 St unweighted"|
                  erg.slope.std.err.melt$refseq=="IPD 1 St transf weighted")
