...
tokeep<-which(erg.slope.std.err.melt$refseq=="IPD 1 St unweighted"|
                  erg.slope.std.err.melt$refseq=="IPD 1 St weighted"|
                  erg.slope.std.err.melt$refseq=="IPD 2 St unweighted"|
                  erg.slope.std.err.melt$refseq=="IPD 2 St FE weighted")
...
plot.erg.int.point <- ggplot(aes(x = value, colour = refseq, 
  ...
  plot.erg.int.point <- plot.erg.int.point + 
    scale_size_manual(values=c(1, 1,
                               1, 1),
                      labels = c("1 St. unweighted    ", "1 St. weighted    ",
                                 "2 St. weighted    ", "2 St. unweighted    "),
...
plot.erg.int.point <- plot.erg.int.point + stat_density(geom="line", 
                                                          position="identity")+
...
plot.erg.slope.point <- ggplot(aes(x = value, colour = refseq, 
  ...
  plot.erg.slope.point <- plot.erg.slope.point + 
    ...
    theme(legend.text=element_text(size=32),
          ...
          axis.title.x = element_text(size = 24),
          legend.key.size =  unit(0.4, "in"))   
plot.erg.slope.point <- plot.erg.slope.point + stat_density(geom="line", 
                                                            position="identity")+
...
plot.erg.int.std.err <- ggplot(aes(x = value, colour = refseq, 
  ...
  plot.erg.int.std.err <- plot.erg.int.std.err + 
    ...
    theme(legend.text=element_text(size=32),
          ...
          axis.title.x = element_text(size = 24),
          legend.key.size =  unit(0.4, "in"))   
plot.erg.int.std.err <- plot.erg.int.std.err + stat_density(geom="line", 
                                                            position="identity")
...
plot.erg.slope.std.err <- plot.erg.slope.std.err + stat_density(geom="line", 
                                                  position="identity")                       
