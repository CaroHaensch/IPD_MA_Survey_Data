## Filename: ~/700_performance_tables/latex_tables_superpop.R
...
### 
  ...
  tokeep<-which(rownames(erg.int.point)=="IPD 1 St RE weighted"|
                  rownames(erg.int.point)=="IPD 1 St weighted"|
                  rownames(erg.int.point)=="IPD 1 St RE weighted B"|
                  rownames(erg.int.point)=="IPD 1 St RE weighted slope"|
                  rownames(erg.int.point)=="IPD 1 St RE weighted B slope")
