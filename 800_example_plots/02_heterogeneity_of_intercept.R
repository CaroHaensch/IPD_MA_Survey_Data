...
## Filename: ~/800_example_plots/02_heterogeneity_of_intercept.R
## Description: Data Visualisation to show the effects of diff strata intercepts
...
# Get data
source("100_data_creation/02_heterogeneity_of_intercepts.R")
...
heterointer <- ggplot(data = data.strata1, aes(x = x, y = y)) + 
...
# Save
pdf(paste0("plots/heterogeneity_intercept_plot.pdf"), width = 8, height = 10)
print(heterointer)
dev.off()
